...
namespace HighScoreTable
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            Console.WriteLine("Welcome! \n How many high scores do you need?");
        Input:
        ...
        Continue:
            ...
            for (int lol = 1; lol < yourscores.Length + 1; lol++)
            {
                Console.WriteLine("Please enter score " + lol + "");
                yourscores[lol - 1] = int.Parse(Console.ReadLine());
            }
        ...
        static void PrintArray(int[] scor)
        {
            for (int neo = 0; neo < scor.Length; neo++)
            {
                Console.WriteLine(scor[neo]);
            }
        }
